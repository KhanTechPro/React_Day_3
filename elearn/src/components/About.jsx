  ...
  return (
    <div className='max-w-[1360px] px-4 mx-auto my-10'>
        <div className='text-center'>
            <p className='text-2xl my-4' data-aos="fade-up">Trusted by 5,000+ Companies Worldwide</p>
            <div className='grid md:grid-cols-6 grid-cols-3  items-center md:w-[1100px] mx-auto mb-[70px]' data-aos="fade-up">
            ...
            <div className='md:w-[450px] text-center inline-block items-center' data-aos="fade-up">
            ...
            <div className='grid md:grid-cols-3 items-center md:w-[1100px] mx-auto relative top-[100px]' data-aos="fade-up">
            ...
            <div className='md:w-[600px] text-center inline-block items-center relative top-[180px] my-6' data-aos="fade-up">
            ...
            <div className='grid md:grid-cols-2 md:gap-8 items-center relative top-[180px] md:w-[900px] mx-auto' data-aos="fade-up">
                <div className='text-center '>
            ...
            <div className='grid md:grid-cols-2 gap-8 md:text-start md:w-[1100px] mx-auto relative top-[160px]' data-aos="fade-up">
                <div className='p-4'>
