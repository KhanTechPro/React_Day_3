...
const Footer = () => {
  return (
    <div className='bg-black w-full h-[600px] relative top-[500px]'>
        <div className='max-w-[1360px] px-4 mx-auto my-10'>
            <div className='grid md:grid-cols-2 md:gap-8 items-center relative top-8 md:w-[300px] mx-auto'>
            ...
            <div className='md:w-[400px] mx-auto text-center relative top-[100px]'>
                <form action="">
                ...
                <div className='md:flex justify-between items-center text-gray-400 text-center md:w-[350px] mx-auto relative top-12'>
                    <p>Careers </p>
                    <p className='md:border md:border-white border-y-0 px-4 py-4'> Privacy Policy </p>
